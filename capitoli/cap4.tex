...
Tuttavia, ciò comporta un aumento significativo dell'errore per correnti prossime a zero. La ragione di questo comportamento, come già discusso nel Paragrafo \ref{sec:limiti_dominio_flusso}, è che tra i punti utilizzati per costruire l'interpolatore non vi sono  punti associati a una corrente prossima a 0. \\
