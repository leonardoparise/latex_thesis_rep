...
\end{equation}
 ...
 Conoscere qu2.726esto dato diviene utile nel caso dell'aggiunta di un filtro passa alto per la rimozione del rumore a bassa frequenza; ciò permette di eliminare i disturbi senza attenuare o sfasare la prima armonica.
...
Si procede poi con l'analizzare l'andamento del flusso D  rispetto alla corrente d o q nominale (Figure \ref{fig:MTPA_Flusso_D_vs_Iq_thetaVar} e \ref{fig:MTPA_Flusso_D_vs_Id_thetaVar})m netre l'altra componente di corrente viene fatta variare.
