...
Inizialmente la mappa diretta di flusso utilizzata aveva un range di corrente $i_d \in [-10,\ 0] \ A$ e $i_q \in [-10,\ 10] \ A$.\\
In seguito si è utilizzato un range diverso $i_d \in [-8,\ 2] \ A$ e $i_q \in [-8 \ 8] \ A$. La motivazione di ciò riguarda l'accuratezza del processo di inversione. Tale scelta verrà giustificata nel Capitolo \ref{chap:inversione}. I grafici del flusso sono stati realizzati a partire dalla seconda mappa.
