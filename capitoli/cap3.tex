...
Nelle Figure \ref{fig:Flusso_D_vs_theta_IdVar} e \ref{fig:Flusso_D_vs_theta_IdVar_iq_1} si può anche notare come l'ampiezza del flusso magnetico e il valore medio tenda ad incrementare all'aumentare della corrente $i_d$.
\begin{figure}
\centering
...
\subsection{Analisi della fcem espresso in funzione della posizione.}
...
Si possono calcolare le coordinate del punto nominale della curva, considerando il vincolo imposto dalla corrente nominale ($I_N = 4.2$ A). Tale punto è individuato dall'intersezione tra la curva MTPA e la circonferenza di corrente avente come raggio la corrente nominale.\\
...
\subsection{Analisi della variazione di $\lambda_{dq}$ lungo la curva MTPA}
