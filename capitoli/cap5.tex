...
\end{aligned}
\end{equation}
dove $v_{d,i}$ e $v_{q,i}$ rappresentano la tensione media in ognuna delle 3 fasi della procedura, mentre $\omega_e$ è la velocità elettrica del rotore. Data la natura sincrona del motore, la velocità elettrica può essere ottenuta a partire dalla velocità meccanica con la seguente relazione:
\begin{equation}
