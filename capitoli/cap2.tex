...
Nel set-up sperimentale il motore di test (MUT) è accoppiato da un motore controllato in velocità. Tale motore trascina il motore di test imponendo una velocità di rotazione costante, per esempio pari a 1/3 della velocità nominale del motore di test.\\
