...
Tenenendo conto che la media integrale di un valore costante ($\boldsymbol{\lambda}_{\alpha\beta}^{y}(t=0)$) equivale proprio a tale valore, si ottiene infine l'equazione \ref{eq:eq1}
