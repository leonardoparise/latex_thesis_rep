...
secondo l’ asse ad essi ortogonale (asse q). L’ induzione magnetica è influenzata anche dal traferro e risulta dipendente anche della posizione del rotore. Le auto e mutue
induttanze non possono
essere considerate costanti, per la loro dipendenza dalla posizione del rotore.\\
...
\end{align*}
 le matrici $\bm{R}$ e $\bm{L}_{abc}$ sono definite come segue:
\begin{equation}
\bm{R} = 
\begin{bmatrix}
    R & 0 & 0 \\[6pt]
