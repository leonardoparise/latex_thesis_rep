...
\begin{table}
    ...
    \end{tabular} 
    \caption{Valore dell'errore di stima per punto operativo. Gli errori percentuali medio e massimo  sono stati calcolati rispetto al flusso medio del punto operativo considerato. }
...
\begin{table}
    ...
    \end{tabular} 
    \caption{Valore dell'errore di stima per punto operativo. L'errore medio e massimo in percentuale  sono stati calcolati rispetto al flusso medio del punto operativo considerato. }
