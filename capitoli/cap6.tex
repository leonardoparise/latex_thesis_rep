...
\end{itemize}
\subsection{Stima del flusso con passaggio di temperatura 20 °C a 25 °C}
...
\begin{table}
    ...
    \end{tabular} 
    \caption{Valore dell'errore di stima del flusso $\lambda_d$ per punto operativo. Gli errori percentuali medio e massimo  sono stati calcolati rispetto al flusso medio del punto operativo considerato. }
...
\begin{table}
    ...
    \end{tabular} 
    \caption{Valore dell'errore di stima del flusso $\lambda_q$ per punto operativo. L'errore medio e massimo in percentuale  sono stati calcolati rispetto al flusso medio del punto operativo considerato. }
    \label{tab:Tabella_errore_stima_q_20_25}   
\end{table}

\subsection{Stima del flusso con range di temperatura 20°-30°}
...
\centering
    ...
    \caption{Confronto dei flussi per il range di temperatura 20°-30°.}
...
\begin{table}
    ...
    \end{tabular} 
    \caption{Valore dell'errore di stima del flusso $\lambda_d$ per punto operativo. Gli errori percentuali medio e massimo  sono stati calcolati rispetto al flusso medio del punto operativo considerato (range di temperatura $20^\circ-30^\circ$). }
...
\subsection{Stima del flusso con range di temperatura 30°-35°}
...
Dalle tabelle e dall'immagine \ref{fig:Confronto_Flussi_PuntoTarget_30_35_Temp} risulta chiaro come l'errore di stima del terzo scenario sia simile a quella del primo scenario. 
...
\begin{table}
    ...
    \end{tabular} 
    \caption{Valore dell'errore di stima del flusso $\lambda_q$ per punto operativo. Gli errori percentuali medio e massimo  sono stati calcolati rispetto al flusso medio del punto operativo considerato. }
